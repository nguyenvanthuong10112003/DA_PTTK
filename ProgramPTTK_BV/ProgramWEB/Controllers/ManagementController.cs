...
namespace ProgramWEB.Controllers
{
    public class ManagementController : BaseController
    {
        ...
        public ActionResult NhanSu(long? ma)
        {
            try
            {
                QuanLy user = (QuanLy)Session[DefineSession.userSession];
                ...
                if (ma!= null && ma > 0)
                    findBy.Add(DefineTable.nhanSu.thuocTinhs[0], ma.Value);
        ...
        public ActionResult PhongBan(long? ma)
        {
            try
            {
                QuanLy user = (QuanLy)Session[DefineSession.userSession];
                ...
                Dictionary<string, long> findBy = new Dictionary<string, long>();
                if (ma != null && ma > 0)
                    findBy.Add(DefineTable.phongBan.thuocTinhs[0], ma.Value);
                Dictionary<string, bool> action = new Dictionary<string, bool>();
                action.Add("search", true);
                try
                {
        ...
        public ActionResult BoPhan(long? ma)
        {
            try
            {
                QuanLy user = (QuanLy)Session[DefineSession.userSession];
                ...
                Dictionary<string, long> findBy = new Dictionary<string, long>();
                if (ma != null && ma > 0)
                    findBy.Add(DefineTable.boPhan.thuocTinhs[0], ma.Value);
                Dictionary<string, bool> action = new Dictionary<string, bool>();
                action.Add("search", true);
                try
                {
        ...
        public ActionResult CaLam(long? ma)
        {
            try
            {
                QuanLy user = (QuanLy)Session[DefineSession.userSession];
                ...
                Dictionary<string, long> findBy = new Dictionary<string, long>();
                if (ma != null && ma > 0)
                    findBy.Add(DefineTable.caLam.thuocTinhs[0], ma.Value);
                Dictionary<string, bool> action = new Dictionary<string, bool>();
                action.Add("search", true);
                try
                {
        ...
        public ActionResult NgayNghi(long? ma)
        {
            try
            {
                QuanLy user = (QuanLy)Session[DefineSession.userSession];
                ...
                Dictionary<string, long> findBy = new Dictionary<string, long>();
                if (ma != null && ma > 0)
                    findBy.Add(DefineTable.ngayNghi.thuocTinhs[0], ma.Value);
                Dictionary<string, bool> action = new Dictionary<string, bool>();
                action.Add("search", true);
                try
                {
        ...
        public ActionResult DuyetDangKy(long? ma)
        {
            try
            {
                ...
                Dictionary<string, long> findBy = new Dictionary<string, long>();
                if (ma != null && ma >= 0)
                    findBy.Add(DefineTable.duyetDangKy.thuocTinhs[0], ma.Value);
                Dictionary<string, bool> action = new Dictionary<string, bool>();
                action.Add("search", true);
                ViewBag.jsonString = ViewBag.jsonString = System.Text.Json.JsonSerializer.Serialize(new
                {
