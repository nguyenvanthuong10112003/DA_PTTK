...
namespace ProgramWEB.Controllers
{
    public class NhanSuController : BaseController
    {
            ...
            try
            {
                ...
                Thread createAccount = new Thread(() => {
                    try
                    {
                        ...
                        Models.Data.NhanSu nhanSu1 = context.NhanSus.Where(item => item.NS_Email == nhanSu.NS_Email).FirstOrDefault();
                        if (nhanSu1 == null)
                            return;
                        ...
                        while (true)
                        { 
                            taiKhoan.TK_TenDangNhap = (name + nhanSu1.NS_Ma).ToLower();
                            if (i >= 0)
        ...
        public ActionResult Profile(long ma)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    data.Add("taiKhoan", user.timTaiKhoanBangMaNhanSu(nhanSu.NS_Ma.Value));
