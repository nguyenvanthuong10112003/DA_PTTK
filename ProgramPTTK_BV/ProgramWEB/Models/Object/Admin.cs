...
namespace ProgramWEB.Models.Object
{
    public class Admin : QuanLy
    {
        ...
        public Admin(string username, long maNhanSu, bool quyenAdmin, bool quyenQuanLy, string avatar) : base(username, maNhanSu, quyenAdmin, quyenQuanLy, avatar)
        {
        }
//Phong ban
        public string themPhongBan(Object.PhongBan result)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(result.PB_Ten) || result.PB_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
                Data.PhongBan old = null;
                if (result.NS_Ma != null && result.NS_Ma > 0) {
        ...
        public string suaPhongBan(Object.PhongBan New)
        {
            try
            {
                if (New == null || New.PB_Ma == null || New.PB_Ma <= 0 || string.IsNullOrEmpty(New.PB_Ten))
                    return DefineError.loiDuLieuKhongHopLe;
                Data.PhongBan old = context.PhongBans.Find(New.PB_Ma);
                if (old == null)
                    return "Phòng ban cần sửa không tồn tại.";
                if (New.NS_Ma != null && New.NS_Ma > 0)
                {
        ...
        public string xoaPhongBan(long ma)
        {
            try
            {
                if (ma <= 0)
        ...
        public string[] xoaNhieuPhongBan(long[] mas)
        {
...
//Bo phan
        public string themBoPhan(Object.BoPhan result)
        {
            try
            {
                if (result == null)
                    return DefineError.loiDuLieuKhongHopLe;
                if (result.PB_Ma == null || result.PB_Ma <= 0 || string.IsNullOrEmpty(result.BP_Ten))
                    return DefineError.loiDuLieuKhongHopLe;
                if (context.PhongBans.Find(result.PB_Ma) == null)
                    return "Phòng ban không tồn tại.";
                Data.BoPhan old = null;
                if (result.NS_Ma != null && result.NS_Ma > 0)
                {
                    if (context.NhanSus.Find(result.NS_Ma) == null)
                        return "Nhân sự không tồn tại";
        ...
        public string suaBoPhan(Object.BoPhan New)
        {
            try
            {
                if (New == null)
                    return DefineError.loiDuLieuKhongHopLe;
                if (New.PB_Ma == null || New.BP_Ma == null || New.PB_Ma <= 0 || New.BP_Ma <= 0 || string.IsNullOrEmpty(New.BP_Ten))
                    return DefineError.loiDuLieuKhongHopLe;
        ...
        public string xoaBoPhan(long ma)
        {
            try
            {
                if (ma <= 0)
        ...
        public string[] xoaNhieuBoPhan(long[] mas)
        {
            string[] results = new string[] { string.Empty, string.Empty };
            try
            {
...
//Ngay nghi
        ...
        public string suaNgayNghi(NgayNghi New)
        {
            try
            {
                if (New == null || New.NN_Ngay == null || New.NN_Ma == null || New.NN_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
...
//Ca lam
        public string themCaLam(CaLam New)
        {
            try
            {
                if (New == null || string.IsNullOrEmpty(New.CL_TenCa) || New.CL_GioBatDau == null ||
                    ...
                    return DefineError.loiDuLieuKhongHopLe;
                Data.CaLam old = context.CaLams.Where(o => 
                                                        (o.CL_GioBatDau == New.CL_GioBatDau && 
                                                         ...
                                                         (
                                                         o.CL_GioBatDau * 60 + o.CL_PhutBatDau <= New.CL_GioBatDau * 60 + New.CL_PhutBatDau &&
                                                         o.CL_GioKetThuc * 60 + o.CL_PhutKetThuc >= New.CL_GioBatDau * 60 + New.CL_PhutBatDau
                                                         ) ||
                                                         (
                                                         o.CL_GioBatDau * 60 + o.CL_PhutBatDau <= New.CL_GioKetThuc * 60 + New.CL_PhutKetThuc &&
                                                         o.CL_GioKetThuc * 60 + o.CL_PhutKetThuc >= New.CL_GioKetThuc * 60 + New.CL_PhutKetThuc
                                                         )
                                                         ).FirstOrDefault();
                if (old == null)
                {
        ...
        public string suaCaLam(CaLam New)
        {
            try
            {
                if (New == null || New.CL_Ma == null || New.CL_Ma <= 0 ||
        ...
        public string xoaCaLam(long ma)
        {
            try
            {
                if (ma <= 0)
        ...
        public string[] xoaNhieuCaLam(long[] mas)
        {
            string[] results = new string[] { string.Empty, string.Empty };
            try
            {
