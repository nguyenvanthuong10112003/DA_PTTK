...
namespace ProgramWEB.Models.Object
{
    public class QuanLy : User
    {
        ...
        public QuanLy(string username, long maNhanSu, bool quyenAdmin, bool quyenQuanLy, string avatar) : base(username, maNhanSu, quyenAdmin, quyenQuanLy, avatar)
        {
        }
//Nhan su
            ...
            try
            {
                if (findNhanSu != null)
                {
                    return Convert<Object.NhanSu, Data.NhanSu>.ConvertObjs(from NhanSu in context.NhanSus
                            where
                            (findNhanSu.NS_Ma != null ? NhanSu.NS_Ma == findNhanSu.NS_Ma : NhanSu != null) &&
        ...
        public Object.NhanSu timKiemMotNhanSu(long maNhanSu)
        {
            try
            {
        ...
        public string themNhanSu(Object.NhanSu nhanSu)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(nhanSu.NS_HoVaTen) ||
                ...
                Data.NhanSu nhanSu1 = context.NhanSus.Where(
                    item => item.NS_SoCCCD == nhanSu.NS_SoCCCD ||
        ...
        public string suaNhanSu(Object.NhanSu nhanSuNew)
        {
            try
            {
                if (nhanSuNew == null)
                    return DefineError.loiDuLieuKhongHopLe;
                if (nhanSuNew.NS_Ma == null || string.IsNullOrEmpty(nhanSuNew.NS_HoVaTen) || nhanSuNew.NS_Ma <= 0 ||
        ...
        public string xoaNhanSu(long maNhanSu)
        {
            try
            {
                if (maNhanSu <= 0)
        ...
        public string[] xoaNhieuNhanSu(long[]maNhanSus)
        {
...
//Bao Hiem
            ...
            try
            {
                ...
                if (find != null)
                {
                    return Convert<Object.BaoHiem, Data.BaoHiem>.ConvertObjs(from BaoHiem in context.BaoHiems
                            ...
                            (find.NS_Ma != null ? BaoHiem.NS_Ma == find.NS_Ma : BaoHiem != null)
                            select BaoHiem);
                }
                return Convert<Object.BaoHiem, Data.BaoHiem>.ConvertObjs(context.BaoHiems);
            }
        ...
        public string themBaoHiem(Object.BaoHiem baoHiem)
        {
            try
            {
                if (baoHiem == null || string.IsNullOrEmpty(baoHiem.BH_SoBaoHiem) ||
                    ...
                    string.IsNullOrEmpty(baoHiem.BH_NoiCap) || baoHiem.NS_Ma == null || baoHiem.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
        ...
        public string suaBaoHiem(Object.BaoHiem New)
        {
            try
            {
                if (New == null || New.BH_Ma == null || New.BH_Ma <= 0 || string.IsNullOrEmpty(New.BH_SoBaoHiem) ||
                    New.BH_NgayCap == null || New.BH_NgayHetHan == null ||
                    string.IsNullOrEmpty(New.BH_NoiCap) || New.NS_Ma == null || New.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
...
//Hop Dong
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.HopDong, Data.HopDong>.ConvertObjs(from HopDong in context.HopDongs
                        ...
                        (find.NS_Ma != null ? HopDong.NS_Ma == find.NS_Ma : HopDong != null) 
                        select HopDong);
                }
                return Convert<Object.HopDong, Data.HopDong>.ConvertObjs(context.HopDongs);
            }
        ...
        public string themHopDong(Object.HopDong New)
        {
            try
            {
                ...
                return "[Hợp đồng cũ của người này chưa kết thúc, không thể thêm mới]";
            }
            catch
            {
                return DefineError.loiHeThong;
...
//Lich su lam viec
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.LichSuLamViec, Data.LichSuLamViec>.ConvertObjs(from LichSuLamViec in context.LichSuLamViecs
                        ...
                        (find.NS_Ma != null ? LichSuLamViec.NS_Ma == find.NS_Ma : LichSuLamViec != null) &&
                        (find.BP_Ma != null ? LichSuLamViec.BP_Ma == find.BP_Ma : LichSuLamViec != null) 
        ...
        public string themLichSuLamViec(Object.LichSuLamViec New)
        {
            try
            {
                if (New == null || New.LSLV_NgayBatDau == null ||
                    string.IsNullOrEmpty(New.LSLV_ChucVu) || New.NS_Ma == null || New.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
                if (context.NhanSus.Find(New.NS_Ma) == null)
                    return "Nhân sự không tồn tại.";
                if (New.BP_Ma != null && context.BoPhans.Find(New.BP_Ma) == null)
        ...
        public string suaLichSuLamViec(Object.LichSuLamViec New)
        {
            try
            {
                if (New == null || New.LSLV_Ma == null || New.LSLV_Ma <= 0 || New.LSLV_NgayBatDau == null ||
                    string.IsNullOrEmpty(New.LSLV_ChucVu) || New.NS_Ma == null || New.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
                if (context.NhanSus.Find(New.NS_Ma) == null)
                    return "Nhân sự không tồn tại.";
...
//Tai khoan
        ...
        public Object.TaiKhoan timTaiKhoanBangMaNhanSu(long maNhanSu)
        {
            try
            {
                if (maNhanSu <= 0)
            ...
            { 
                if (findTaiKhoan != null)
                {
                    return Convert<Object.TaiKhoan, Data.TaiKhoan>.ConvertObjs(from TaiKhoan in context.TaiKhoans
                            ...
                            (findTaiKhoan.NS_Ma != null ? TaiKhoan.NS_Ma == findTaiKhoan.NS_Ma : TaiKhoan != null) 
                            select TaiKhoan);
                }
                return Convert<Object.TaiKhoan, Data.TaiKhoan>.ConvertObjs(context.TaiKhoans);
            }
...
//Khen thuong ky luat
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.KhenThuongKyLuat, Data.KhenThuongKyLuat>.ConvertObjs(from KhenThuongKyLuat in context.KhenThuongKyLuats
                        ...
                        (find.NS_Ma != null ? KhenThuongKyLuat.NS_Ma == find.NS_Ma : KhenThuongKyLuat != null) 
        ...
        public string themKhenThuongKyLuat(Object.KhenThuongKyLuat New)
        {
            try
            {
                if (New == null || string.IsNullOrEmpty(New.KTKL_HinhThuc) ||
                    New.KTKL_SoTien == null || New.NS_Ma == null || New.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
                if (context.NhanSus.Find(New.NS_Ma) == null)
                    return "Nhân sự không tồn tại.";
                Data.KhenThuongKyLuat vali = new Data.KhenThuongKyLuat();
        ...
        public string suaKhenThuongKyLuat(Object.KhenThuongKyLuat New)
        {
            try
            {
                if (New == null || New.KTKL_Ma == null || New.KTKL_Ma <= 0 || string.IsNullOrEmpty(New.KTKL_HinhThuc) ||
                    New.KTKL_SoTien == null || New.NS_Ma == null || New.NS_Ma <= 0)
                    return DefineError.loiDuLieuKhongHopLe;
                if (context.NhanSus.Find(New.NS_Ma) == null)
                    return "Nhân sự không tồn tại.";
...
//Phong ban
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.PhongBan, Data.PhongBan>.ConvertObjs(from PhongBan in context.PhongBans
                        where
                        (find.PB_Ma != null ? PhongBan.PB_Ma == find.PB_Ma : PhongBan != null) &&
                        ...
                        (find.NS_Ma != null ? PhongBan.NS_Ma == find.NS_Ma : PhongBan != null)
                        select PhongBan);
                }
                return Convert<Object.PhongBan, Data.PhongBan>.ConvertObjs(context.PhongBans);
            }
        ...
        public Object.PhongBan timKiemMotPhongBan(long ma)
        {
            try
            {
                if (ma <= 0)
...
//Bo Phan
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.BoPhan, Data.BoPhan>.ConvertObjs(from BoPhan in context.BoPhans
                        where
                        (find.BP_Ma != null ? BoPhan.BP_Ma == find.BP_Ma : BoPhan != null) &&
                        ...
                        (find.PB_Ma != null ? BoPhan.PB_Ma == find.PB_Ma : BoPhan != null) &&
                        (find.NS_Ma != null ? BoPhan.NS_Ma == find.NS_Ma : BoPhan != null)
                        select BoPhan);
                }
                return Convert<Object.BoPhan, Data.BoPhan>.ConvertObjs(context.BoPhans);
            }
        ...
        public Object.BoPhan timKiemMotBoPhan(long ma)
        {
            try
            {
                if (ma <= 0)
...
//Ca Lam
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.CaLam, Data.CaLam>.ConvertObjs(from CaLam in context.CaLams
                        where
                        (find.CL_Ma != null ? CaLam.CL_Ma == find.CL_Ma : CaLam != null) &&
        ...
        public Object.CaLam timKiemMotCaLam(long ma)
        {
            try
            {
                if (ma <= 0)
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.ChamCong, Data.ChamCong>.ConvertObjs(from ChamCong in context.ChamCongs
                        ...
                        (find.NS_Ma != null ? ChamCong.NS_Ma == find.NS_Ma : ChamCong != null)
                        select ChamCong);
                }
                return Convert<Object.ChamCong, Data.ChamCong>.ConvertObjs(context.ChamCongs);
            }
...
//Dang Ky Ca Lam
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.DangKyCaLam, Data.DangKyCaLam>.ConvertObjs(from DangKyCaLam in context.DangKyCaLams
                        ...
                        (find.NS_Ma != null ? DangKyCaLam.NS_Ma == find.NS_Ma : DangKyCaLam != null) &&
                        (find.CL_Ma != null ? DangKyCaLam.CL_Ma == find.CL_Ma : DangKyCaLam != null) 
                        select DangKyCaLam);
                }
                return Convert<Object.DangKyCaLam, Data.DangKyCaLam>.ConvertObjs(context.DangKyCaLams);
            }
        ...
        public Object.DangKyCaLam timKiemMotDangKyCaLam(long ma)
        {
            try
            {
                if (ma <= 0)
        ...
        public string duyetDangKyCaLam(long maDK)
        {
            try
            {
                if (maDK <= 0)
                ...
                if (dangKyCaLam == null)
                    return DefineError.khongTonTai;
                if (dangKyCaLam.DKCL_Ngay <= DateTime.Now)
                    return "Đăng ký này đã quá hạn";
...
//Dang Ky Nghi Lam
        ...
        public List<IEnumerable<Object.DangKyNghiLam>> layDanhSachDangKyNghiLam(Object.DangKyNghiLam findBy = null, int page = 1, int pageSize = 10, string sortBy = "DKNL_Ma", bool sortTangDan = true)
        {
            try
            {
            ...
            try
            {
                if (find != null)
                {
                    return Convert<Object.DangKyNghiLam, Data.DangKyNghiLam>.ConvertObjs(from DangKyNghiLam in context.DangKyNghiLams
                        ...
                        (find.NS_Ma != null ? DangKyNghiLam.NS_Ma == find.NS_Ma : DangKyNghiLam != null) &&
        ...
        public Object.DangKyNghiLam timKiemMotDangKyNghiLam(long ma)
        {
            try
            {
                if (ma <= 0)
        ...
        public string duyetDangKyNghiLam(long maDK)
        {
            try
            {
                if (maDK <= 0)
                ...
                if (dangKyNghiLam == null)
                    return DefineError.khongTonTai;
                if (dangKyNghiLam.DKNL_Ngay <= DateTime.Now)
                    return "Đăng ký này đã quá hạn";
                if (dangKyNghiLam.DKNL_DaDuocDuyet && dangKyNghiLam.DDK_Ma != null)
                    return "Đăng ký này đã được duyệt rồi";
                Data.DuyetDangKy duyetDangKy = new Data.DuyetDangKy();
                duyetDangKy.NS_Ma = this.maNhanSu;
                DateTime now = DateTime.Now;
